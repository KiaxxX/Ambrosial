...
def push_dd(sckey, desp=""):
    ...
    if sckey == '':
        ...
        json_data = ding.send_text(msg=param, at_dingtalk_ids=['8ke-8x04ndda6', 'lkh017'])
...
if __name__ == "__main__":
    print(
        f"[{now}][INFO]: StepS Has Started And Been Loading！It Will Take A Little Seconds, Please Keep Patient!")
    # Push Mode  # 推送选项
    # Pm = input()
    Pm = 'dd'  # 微信推送
    if Pm == 'dd':
